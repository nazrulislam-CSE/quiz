                    ...
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('title') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $counter->title  }}" class=" form-control" name="title" placeholder="Counter Title">
                         </div>
                     </div>
                     ...
                     <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('counter_no') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="number" min="0" value="{{ $counter->counter_no  }}" class=" form-control" name="counter_no" placeholder="Counter Number">
                         </div>
                     </div>
                        ...
                        <div class="input-group">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                <option value="1" @if($counter->status == 1) selected @endif>Active</option>
                                <option value="0" @if($counter->status == 0) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
  
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Counter</button>
                    </div>
                </div>
            </form>
        </div>
