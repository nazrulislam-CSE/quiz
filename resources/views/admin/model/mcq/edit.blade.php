@extends('layouts.admin.app', [$pageTitle ?? 'MCQ' => 'Edit Model MCQ'])
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Model MCQs</a></li>
        ...
        <div class="row row-sm">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    <p class="card-title my-0">{{ $pageTitle ?? 'Edit Model MCQ Questions' }}</p>
                    <div class="d-flex">
                        <a href="{{ route('admin.model.mcq.show', [
                            ...
                            'model' => $topicInfo->model_test_id,
                        ]) }}"
                            class="btn btn-info me-2">
                            <i class="fas fa-eye"></i> View Questions
                        </a>
                        <a href="{{ route('admin.model.mcq.index') }}" class="btn btn-danger">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <strong>Model Test:</strong> {{ $topicInfo->modelTest->name ?? '-' }}
                            </div>
                        </div>
                        <div class="mt-2">
                    ...
                    <form
                        action="{{ route('admin.model.mcq.update', [
                            'admission' => $topicInfo->admission_id,
                            'department' => $topicInfo->department_id,
                            'group' => $topicInfo->group_id,
                            'model' => $topicInfo->model_test_id,
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if ($question->answers->count() > 0)
                                            ...
                                            <div class="mt-3 d-flex justify-content-end">
                                                <a href="{{ route('admin.single.model.mcq.destroy', $question->id) }}" id="delete"
