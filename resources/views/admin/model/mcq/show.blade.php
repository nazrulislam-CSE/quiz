        ...
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Model Test MCQs</a></li>
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="info-box bg-light">
                        <div class="info-box-content">
                            <span class="info-box-text text-muted">Model Test</span>
                            <span class="info-box-number">{{ $topicInfo->modelTest->name ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
