              ...
              <div class="row">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('designation') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ old('designation') }}" class=" form-control" name="designation" placeholder="Enter Designation">
                         </div>
                     </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ old('facebook_url') }}" class=" form-control" name="facebook_url" placeholder="Enter Facebok Url">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ old('linkedin_url') }}" class=" form-control" name="linkedin_url" placeholder="Enter Linkedin Url">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ old('twitter_url') }}" class=" form-control" name="twitter_url" placeholder="Enter Twitter Url">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ old('whatsapp_url') }}" class=" form-control" name="whatsapp_url" placeholder="Enter Whatsapp Url">
                        </div>
                    </div>
                   ...
                   <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       <img id="showImage" src="{{ (!empty($profile->image)) ? url('upload/teacher/'.$profile->image):url('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                   </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i>Add Teacher</button>
                    </div>
                </div>
            </form>
        </div>
