                        ...
                        <form method="GET" class="form-inline">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ route('admin.balance.request.index') }}"
                        ...
                        <table id="file-datatable"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">পরিশোধের সময়</th>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        ...
                                        <a href="{{ url('upload/balance/'.$request->screenshot) }}" target="_blank">
                                            <img src="{{ url('upload/balance/'.$request->screenshot) }}"
                                    ...
                                    <td>
                                        <a href="{{ route('admin.balance.request.show', $request->id) }}"
                                            class="btn btn-success btn-sm mr-2"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('admin.balance.request.edit', $request->id) }}"
                                            class="btn btn-primary btn-sm mr-2"><i class="fas fa-edit"></i></a>
                                        <a href="{{ route('admin.balance.request.delete', $request->id) }}"
