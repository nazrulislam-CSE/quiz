        ...
        <div class="card-body">
            <form action="{{ route('admin.slider.update',$slider->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                   ...
                   <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       <img id="showImage" src="{{ (!empty($slider->image)) ? url('upload/slider/'.$slider->image):url('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                   </div>
                        ...
                        <div class="input-group">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                ...
                                <option value="0" @if($slider->status == 0) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
  
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Slider</button>
                    </div>
                </div>
            </form>
        </div>
