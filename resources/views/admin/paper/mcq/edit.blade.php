@extends('layouts.admin.app', [$pageTitle ?? 'MCQ' => 'Edit Paper Final MCQ'])
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Paper Final MCQs</a></li>
        ...
        <div class="row row-sm">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                    <p class="card-title my-0">{{ $pageTitle ?? 'Edit Paper Final MCQ Questions' }}</p>
                    <div class="d-flex">
                        <a href="{{ route('admin.paper.mcq.show', [
                            'admission' => $topicInfo->admission_id,
                            'department' => $topicInfo->department_id,
                            'group' => $topicInfo->group_id,
                            'subject' => $topicInfo->subject_id,
                            'paper' => $topicInfo->paper_final_id,
                        ]) }}"
                            class="btn btn-info me-2">
                            <i class="fas fa-eye"></i> View Questions
                        </a>
                        <a href="{{ route('admin.paper.mcq.index') }}" class="btn btn-danger">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                              ...
                              <div class="col-md-3">
                                <strong>Group:</strong> {{ $topicInfo->group->name ?? '-' }}
                            </div>
                            <div class="col-md-3">
                                <strong>Subject:</strong> {{ $topicInfo->subject->name ?? '-' }}
                            </div>
                            <div class="col-md-3 mt-3">
                                <strong>Paper Final:</strong> {{ $topicInfo->paperFinal->name ?? '-' }}
                            </div>
                        </div>
                        <div class="mt-2">
                    ...
                    <form
                        action="{{ route('admin.paper.mcq.update', [
                            'admission' => $topicInfo->admission_id,
                            'department' => $topicInfo->department_id,
                            'group' => $topicInfo->group_id,
                            'subject' => $topicInfo->subject_id,
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if ($question->answers->count() > 0)
                                            ...
                                            <div class="mt-3 d-flex justify-content-end">
                                                <a href="{{ route('admin.single.paper.mcq.destroy', $question->id) }}" id="delete"
