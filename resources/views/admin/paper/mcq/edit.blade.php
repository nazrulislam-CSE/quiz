    ...
    <div class="d-flex align-items-center">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.paper.mcq.index') }}">MCQ List</a></li>
...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.paper.mcq.update', $mcq->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        {{-- select paper --}}
                        <div class="col-md-4 mb-3">
                            <label for="paper_final_id" class="form-label">Paper <span class="text-danger">*</span></label>
...
<script>
    $(document).ready(function() {
        ...
        // Dynamic dropdowns for Admission, Department,Group, Subject, Paper
        $('#admission_id').on('change', function () {
            ...
            if (admissionID) {
                $.ajax({
                    url: '/admin/paper/mcq/get-departments/' + admissionID,
                    type: "GET",
                    dataType: "json",
        ...
        $('#department_id').on('change', function () {
            ...
            if (departmentID) {
                $.ajax({
                    url: '/admin/paper/mcq/get-groups/' + departmentID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('#group_id').html('<option value="">Select Group</option>');
        ...
        $('#group_id').on('change', function () {
            ...
            if (groupID) {
                $.ajax({
                    url: '/admin/paper/mcq/get-subjects/' + groupID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('#subject_id').html('<option value="">Select Subject</option>');
        ...
        $('#subject_id').on('change', function () {
            ...
            if (subjectID) {
                $.ajax({
                    url: '/admin/paper/mcq/get-papers/' + subjectID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('#paper_final_id').html('<option value="">Select Paper</option>');
        ...
        $(document).on('click', '.remove-question', function() {
            ...
            if (questionId) {
                if (confirm('Are you sure you want to delete this question? This action cannot be undone.')) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.paper.mcq.delete-question') }}",
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
