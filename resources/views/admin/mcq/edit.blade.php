...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.mcq.update',$mcq->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        {{-- select admission --}}
                        <div class="form-group col-xl-4 col-lg-4 col-md-4">
                            ...
                            <select name="admission_id" id="admission_id" class="form-control">
                                ...
                                @foreach ($admissions as $admission)
                                    <option value="{{ $admission->id }}" {{ $mcq->admission_id == $admission->id ? 'selected' : '' }}>{{ $admission->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-xl-4 col-lg-4 col-md-4">
                            ...
                            <select name="department_id" id="department_id" class="form-control">
                                ...
                                @foreach ($departments as $department)
                                    <option value="{{ $department->id }}" {{ $mcq->department_id == $department->id ? 'selected' : '' }}>{{ $department->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-xl-4 col-lg-4 col-md-4">
                            ...
                            <select name="topic_id" id="topic_id" class="form-control">
                                ...
                                @foreach ($topics as $topic)
                                    <option value="{{ $topic->id }}" {{ $mcq->topic_id == $topic->id ? 'selected' : '' }}>{{ $topic->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div id="questions-wrapper" class="col-12 mt-3">
                            <div class="card mb-4 p-3 question-block">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="questions[0][text]" class="form-control" placeholder="Enter question" required>{{ $mcq->question }}</textarea>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-2 option-item">
                                                <input type="text" name="questions[0][answers][{{ $index }}][answer]" 
                                                    class="form-control" placeholder="Option {{ $index+1 }}" 
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                            <button type="submit" class="add-to-cart btn btn-success btn-block">
                                <i class="fas fa-save"></i> Update MCQ
                            </button>
                        </div>
                    </div>
                </form>
