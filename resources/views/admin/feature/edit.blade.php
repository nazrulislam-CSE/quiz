                   ...
                   <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('icon') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $feature->icon }}" class=" form-control" name="icon" placeholder="Enter Font Awesome ICON">
                         </div>
                    </div>
                    ...
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('title') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $feature->title }}" class=" form-control" name="title" placeholder="Enter Title">
                         </div>
                     </div>
                        ...
                        <div class="input-group">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                ...
                                <option value="0" @if($feature->status == 0) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
  
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Feature</button>
                    </div>
                </div>
            </form>
        </div>
