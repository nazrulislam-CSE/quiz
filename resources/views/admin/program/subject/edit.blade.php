...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.program.subject.index')}}" class="btn btn-danger me-2">
                    <i class="fas fa-list d-inline"></i> Program List
                </a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.program.subject.update',$program->id)}}" method="post" enctype="multipart/form-data">
                @csrf
              <div class="row">
                 <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $program->name }}" class=" form-control" name="name" placeholder="Enter Name">
                        </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                ...
                                <option value="0" @if($program->status == 0) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
  
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-paper-plane"></i> Update Program Subject</button>
                    </div>
                </div>
            </form>
        </div>
