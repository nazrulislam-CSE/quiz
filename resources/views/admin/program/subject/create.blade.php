        ...
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a href="{{ route('admin.program.subject.index')}}" class="btn btn-danger me-2">
                    <i class="fas fa-list d-inline"></i> Program Subject List
                </a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.program.subject.store')}}" method="post" enctype="multipart/form-data">
                @csrf
              <div class="row">
                  ...
                  <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Add Program Subject</button>
                    </div>
                </div>
            </form>
        </div>
