                    ...
                    <form action="{{ route('admin.program.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-2 col-lg-2 col-md-2">
                                <img id="showImage"
                                    src="{{ !empty($profile->image) ? url('upload/program/' . $profile->image) : url('upload/no_image.jpg') }}"
                                ...
                                <table class="table table-bordered" id="subjects_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="subjects[0][topic_name]" class="form-control"
                                                    placeholder="Enter Topic"></td>
                                            <td><input type="number" name="subjects[0][total_mcq]" class="form-control"
                                                    placeholder="0"></td>
                                            <td><input type="number" name="subjects[0][time]" class="form-control"
                                                    placeholder="Minutes"></td>
                                            <td><input type="number" name="subjects[0][exam_fee]" class="form-control"
                                                    placeholder="Fee"></td>
                                            <td>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                <button type="submit" class="add-to-cart btn btn-success btn-block"><i
                                        class="fas fa-plus"></i> Add Program</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@push('admin')
    ...
    <script>
        ...
        document.getElementById('addRow').addEventListener('click', function () {
            ...
            let newRow = `
                <tr>
                    ...
                    <td><input type="text" name="subjects[${rowIndex}][topic_name]" class="form-control" placeholder="Enter Topic"></td>
                    <td><input type="number" name="subjects[${rowIndex}][total_mcq]" class="form-control" placeholder="0"></td>
                    <td><input type="number" name="subjects[${rowIndex}][time]" class="form-control" placeholder="Minutes"></td>
                    <td><input type="number" name="subjects[${rowIndex}][exam_fee]" class="form-control" placeholder="Fee"></td>
                    <td class="text-left">
                        <!-- Left Plus -->
        ...
        // Dynamic Delegation for Add & Remove
        document.addEventListener('click', function (e) {
            if (e.target.closest('.addRow')) {
                document.getElementById('addRow').click(); // simulate addRow
            }
