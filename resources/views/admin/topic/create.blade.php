                ...
                <div class="row">
                    ...
                    <div class="form-group col-xl-4 col-lg-4 col-md-4">
                        <div class="form-group">
                          <label for="fee">Exam Fee (Use Only Amount): <span class="text-danger">*</span></label>
                            <input type="number" min="0" name="fee" value="{{ old('fee') }}" id="fee" class="form-control" placeholder="Ex:100">
                            @error('fee')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                     <div class="form-group">
                       <label for="name">Topics Name: <span class="text-danger">*</span></label>
                        <input type="text" name="name" value="{{ old('name') }}" id="name" class="form-control" placeholder="Enter Topic name">
                        @error('name')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                    ...
                    <div class="form-group col-xl-4 col-lg-4 col-md-4">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="1">MCQ Exam</option>
                            <option value="2" selected>Study Question</option>
                        </select>
                    </div>
                   ...
                   <div class="form-group col-xl-1 col-lg-1 col-md-1">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Add Topic</button>
                    </div>
                </div>
            </form>
        </div>
