...
<div class="main-content-body">
    <div class="row row-sm">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.topic.mcq.update', $mcq->id) }}" method="post">
                    @csrf
                    @method('PUT')
...
<script>
    $(document).ready(function() {
        ...
        $('#admission_id').on('change', function () {
            ...
            if (admissionID) {
                $.ajax({
                    url: '/admin/topic/mcq/get-departments/' + admissionID,
                    type: "GET",
                    dataType: "json",
        ...
        $('#department_id').on('change', function () {
            ...
            if (departmentID) {
                $.ajax({
                    url: '/admin/topic/mcq/get-subjects/' + departmentID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('#subject_id').html('<option value="">Select Subject</option>');
        ...
        $('#subject_id').on('change', function () {
            ...
            if (subjectID) {
                $.ajax({
                    url: '/admin/topic/mcq/get-topics/' + subjectID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('#topic_id').html('<option value="">Select Topic</option>');
