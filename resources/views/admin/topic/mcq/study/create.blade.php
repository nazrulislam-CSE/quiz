@extends('layouts.admin.app', ['pageTitle' => 'Create MCQ'])
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xl-8 col-lg-8 col-md-8">
                                        ...
                                        <small class="text-muted">
                                            ...
                                            <br><a href="{{ route('admin.topic.study.mcq.download-sample') }}" class="btn btn-sm btn-info mt-2">
...
@push('admin')
    <script>
        $(document).ready(function(){
            // Manual Entry - Load departments when admission changes
            ...
            // Manual Entry - Load subjects when department changes
            ...
            // Manual Entry - Load topics when subject changes
