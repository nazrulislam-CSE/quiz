                 ...
                 <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control">
                                <option value="1" {{ old('type', 1) == 1 ? 'selected' : '' }}>All</option>
                                <option value="2" {{ old('type') == 2 ? 'selected' : '' }}>Front Page</option>
                            </select>
                        </div>
                    </div>
                   ...
                   <div class="form-group col-xl-1 col-lg-1 col-md-1">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Add Admission</button>
                    </div>
                </div>
            </form>
        </div>
