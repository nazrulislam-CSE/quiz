                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <select name="admission_id" id="admission_id" class="form-control select2">
                            ...
                            @foreach ($admissions as $admission)
                                <option value="{{ $admission->id }}" {{ $subject->admission_id == $admission->id ? 'selected' : '' }}>
                                    {{ $admission->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                     <div class="form-group">
                       <label for="name">Name: <span class="text-danger">*</span></label>
                        <input type="text" name="name" value="{{ $subject->name }}" id="name" class="form-control" placeholder="Enter name">
                        @error('name')
                        ...
                        <div class="input-group">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                ...
                                <option value="0" @if($subject->status == 0) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
