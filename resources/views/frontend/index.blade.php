...
<style>
                            ...
                            <div class="card-body p-1-9">
                                <div class="d-flex">
                                    <div class="flex-grow-1 ps-4">
                                        ...
                                        <a class="animate-charcter btn btn-sm w-100 text-light" href="#">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-1-9">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ps-4">
                                ...
                                <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.study.page',$study->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-1-9">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ps-4">
                                ...
                                <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.education.page',$education->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- =========== BANNER PHOTO  ============ -->
    @php
        $topBanner = get_setting('top_banner')->value ?? null;
        $topBanner1 = get_setting('top_banner1')->value ?? null;
    @endphp

    @if($topBanner || $topBanner1)
        <section class="bg-light services_section">
            <div class="row">
                @if($topBanner)
                    <div class="col-lg-6">
                        <img class="rounded avatar-lg" src="{{ asset($topBanner) }}" alt="No Image" width="100%">
                    </div>
                @endif

                @if($topBanner1)
                    <div class="col-lg-6">
                        <img class="rounded avatar-lg" src="{{ asset($topBanner1) }}" alt="No Image" width="100%">
                    </div>
                @endif
            </div>
        </section>
                ...
                @foreach($umrahs as $umrah)
                    <div class="card card-style-03 border-0 text-center primary-shadow">
                        ...
                        <div class="card-body pt-5 pb-1-9 px-1-6 px-sm-2-3">
                            ...
                            <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.umrah.page',$umrah->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                @foreach($tours as $tour)
                    <div class="card card-style-03 border-0 text-center primary-shadow">
                        ...
                        <div class="card-body pt-5 pb-1-9 px-1-6 px-sm-2-3">
                            ...
                            <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.tour.page',$tour->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="bg-light services_section">
        <div class="container">
            ...
            <div class="mb-2-9 mb-lg-6 position-relative text-center wow fadeInUp" data-wow-delay="200ms">
                <h4 class="text-primary text-uppercase letter-spacing-4 d-block mb-2 font-weight-bolder">Medical Visa & Tourism
                </h4>
                    ...
                    <div class="card-body p-1-9">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ps-4">
                                ...
                                <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.tourist.page',$visa->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- =========== BANNER PHOTO  ============ -->
    @php
        $topBanner = get_setting('middle_banner')->value ?? null;
        $topBanner1 = get_setting('middle_banner1')->value ?? null;
    @endphp
                    ...
                    <div class="card-body p-1-9">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ps-4">
                                ...
                                <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.service.page',$service->slug) }}">Read More<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-light services_section">
        <div class="container">
            ...
            <div class="mb-2-9 mb-lg-6 position-relative text-center wow fadeInUp" data-wow-delay="200ms">
                <h4 class="text-primary text-uppercase letter-spacing-4 d-block mb-2 font-weight-bolder">Our Book Stall</h4>
                {{-- <h2 class="display-22 display-sm-18 display-md-16 display-lg-14 display-xl-10 mb-lg-1-6">We provide  best Product.</span></h2> --}}
            </div>
            ...
            <div class="service-carousel owl-carousel owl-theme">
                ...
                <div class="card card-style-03 border-0 text-center primary-shadow">
                    ...
                    <div class="card-body pt-5 pb-1-9 px-1-6 px-sm-2-3">
                        ...
                        <a class="animate-charcter btn btn-sm w-100 text-light" href="{{ route('single.product.page',$product->slug) }}">Order Now<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a>
                    </div>
                    {{-- <a class="animate-charcter btn btn-sm w-100 text-light btn-block" href="{{ route('single.product.page',$product->slug) }}">Order Now<i class="fa-solid fa-arrow-right ps-2 display-30 text-primary"></i></a> --}}
                </div>
                @endforeach
            </div>
                    ...
                    <div class="card card-style07 rounded-0 border-0 primary-shadow">
                        ...
                        <div class="card-body p-4 text-center position-relative">
                            <div class="text-end team-content">
                                ...
                                <span class="display-30">{{ $team->designation ?? ''}}</span></span>
                            </div>
                            <div class="social-icons position-absolute bottom-0 left-0">
                                <span class="icon"><i class="fas fa-share-alt"></i></span>
                                <ul class="social-link1">
                                    <li><a href="{{ $team->facebook_url ?? ''}}" class="linkedin shadow-none"><i class="fab fa-facebook"></i></a></li>
                                    <li><a href="{{ $team->linkedin_url ?? ''}}" class="instagram shadow-none"><i class="fab fa-linkedin"></i></a></li>
                                    <li><a href="{{ $team->twitter_url ?? ''}}" class="pinterest shadow-none"><i class="fab fa-twitter"></i></a></li>
                                </ul>
                                <ul class="social-link2 d-flex">
                                    <li><a target="_blank" href="{{ $team->facebook_url ?? ''}}" class="youtube"><i class="fab fa-facebook"></i></a></li>
                                    <li><a target="_blank" href="{{ $team->linkedin_url ?? ''}}" class="facebook"><i class="fab fa-linkedin"></i></a></li>
                                    <li><a target="_blank" href="{{ $team->twitter_url ?? ''}}" class="twitter"><i class="fab fa-twitter"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="row gx-5 mt-n2-9 position-relative z-index-9">
                ...
                <div class="col-md-6 col-xl-3 mt-2-9 wow fadeInUp" data-wow-delay="200ms">
                    <div class="card card-style07 rounded-0 border-0 primary-shadow">
                        <img src="{{ (!empty($agent->image)) ? url('upload/user_images/'.$agent->image):url('upload/no_image.jpg') }}" 
                        alt="..." 
                        class="img-fluid" 
                        ...
                        <div class="card-body p-4 text-center position-relative">
                            ...
                            <div class="text-center">
                                <h3 class="h5 mb-2">{{ $agent->owner_name ?? ''}}</h3>
                                <h3 class="h5 mb-2 display-30">{{ $agent->designation ?? ''}}</h3>
                                <a href="#" class="animate-charcter btn btn-sm w-100 text-light btn-block">Agent Area: {{ $agent->city_name ?? ''}}</a>
                            </div>
                        </div>
                    </div>
                </div>
