                                ...
                                @if ($selectedAdmissionData && $selectedAdmissionData->name == 'পেপার ফাইনাল এক্সাম')
                                    ...
                                    @if ($selectedSubject && !$selectedPaperFinal)
                                        <div class="step-content active" id="step-paper-final">
                                            <h5 class="step-title"><i class="fas fa-file-alt me-2"></i>Select Paper Final
                                            </h5>
                                            <input type="hidden" name="admission" value="{{ $selectedAdmission }}">
                                            <input type="hidden" name="department" value="{{ $selectedDepartment }}">
                                            <input type="hidden" name="group" value="{{ $selectedGroup }}">
                                                ...
                                                @foreach ($paperFinals as $paperFinal)
                                                    <label for="paper_final{{ $paperFinal->id }}"
                                                        ...
                                                        <img src="{{ !empty($paperFinal->image) ? url('upload/paper_final/' . $paperFinal->image) : url('upload/mcq.png') }}"
                                                            alt="ICON"
                                                            style="width:40px;height:40px;object-fit:cover;">
                                                        <input type="radio" name="paper_final"
                                                            id="paper_final{{ $paperFinal->id }}"
                                                ...
                                                @foreach ($modelTests as $modelTest)
                                                    <label for="model_test{{ $modelTest->id }}"
                                                        ...
                                                        <img src="{{ !empty($modelTest->image) ? url('upload/model_test/' . $modelTest->image) : url('upload/mcq.png') }}"
                                                            alt="ICON"
                                                            style="width:40px;height:40px;object-fit:cover;">
                                                        <input type="radio" name="model_test"
                                                            id="model_test{{ $modelTest->id }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small">
                                                        নিচের তালিকা থেকে আপনার পছন্দের {{ $itemName }} নির্বাচন করুন
                                                        এবং পরীক্ষা শুরু করুন।
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small">
                                                        প্রতিটি {{ $itemName }} এর জন্য আলাদা পরীক্ষার সময় নির্ধারিত
                                                        আছে যা {{ $itemName }} এর পাশে দেখানো হয়েছে।
                                            ...
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small">
                                                        প্রতিটি পরীক্ষার জন্য সর্বোচ্চ মার্ক নির্ধারিত আছে যা
                                                        {{ $itemName }} এর পাশে দেখানো হয়েছে।
                                            ...
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small text-danger">
                                                        এখনই বাটনে ক্লিক করলে পরীক্ষা শুরু হবে এবং আপনার ওয়ালেট থেকে
                                                        স্বয়ংক্রিয়ভাবে
                                                        পরীক্ষার ফি কেটে নেয়া হবে।
                                                    </p>
                                                    <p class="mb-0 small">
                                                        প্রতিটি {{ $itemName }} এর জন্য আলাদা ফি নির্ধারিত আছে যা
                                                        {{ $itemName }} এর পাশে দেখানো হয়েছে।
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="option-item p-2 rounded mb-2" style="cursor:pointer;"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <input class="form-check-input me-2" type="radio"
                                                            name="answers[{{ $mcq->id }}]"
                                                            id="option{{ $answer->id }}" value="{{ $answer->id }}"
                                                            required hidden>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="options mb-3">
                                                @foreach ($mcq->answers->take(4) as $answer)
                                                    <p
                                                        class="mb-1 {{ $answer->is_correct ? 'text-success fw-bold' : '' }}">
                                            ...
                                            @endphp
                                            @if ($correctAnswer)
                                                <p class="mt-2 text-success fw-bold"><strong>সঠিক উত্তর:</strong>
