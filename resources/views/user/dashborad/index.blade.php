        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">মোট ব্যালেন্স: <span class="text-success fw-bold">৳{{
                            number_format($mainWallet, 2) }}</span></h5>
                    <h5 class="card-title mb-0">মোট আয়: <span class="text-success fw-bold">৳{{
                            number_format($incomeWallet, 2) }}</span></h5>
...
<div class="row mb-4 g-3">
    ...
    {{-- <div class="col-md-4 col-sm-6">
        <div class="card shadow-sm border-0 rounded-3 h-100" style="background:#ffbfbfdd !important;">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h6 class="mb-1 fw-bold">মোট আয়</h6>
                    <p class="mb-0 text-muted">Total: <span class="fw-bold text-dark">৳
                            {{ number_format($incomeWallet ?? 0, 2) }}</span></p>
                </div>
            </div>
        </div>
    </div> --}}
    ...
    $isDisabled = ($user->main_wallet < 100 || $user->status != 1);
        ...
        <div class="col-md-4 col-sm-6">
            <a href="{{ $isDisabled ? 'javascript:void(0)' : route('user.mcq.exam') }}"
                ...
                <div class="card shadow-sm border-0 rounded-3 h-100"
                    style="background:#ffbfbfdd !important; {{ $isDisabled ? 'opacity:0.6; pointer-events:none;' : '' }}">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3">
        ...
        <!-- লেনদেনের ইতিহাস -->
        <div class="col-md-4 col-sm-6">
            <a href="{{ route('user.transaction.history') }}" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-3 h-100" style="background:#ffbfbfdd !important;">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3">
                            <div class="bg-success text-white rounded-circle d-flex align-items-center justify-content-center"
                        ...
                        <div>
                            <h6 class="mb-0 fw-bold text-dark">লেনদেনের ইতিহাস</h6>
                        </div>
                    </div>
                </div>
            </a>
