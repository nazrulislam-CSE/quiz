                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            <strong>Student Visa Commission</strong>
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $student_visa_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card overflow-hidden project-card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            <strong>Work Permit Commission</strong>
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $work_visa_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card overflow-hidden project-card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            <strong>Medical Commission</strong>
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $medical_visa_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card overflow-hidden project-card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            <strong>Tourist Commission</strong>
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $tourist_visa_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card overflow-hidden project-card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            <strong>Software Sale Commission</strong>
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $software_visa_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            ...
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ Auth::user()->visa_amount ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            ...
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $total_pending_commission ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            ...
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ Auth::user()->withdraw_amount ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="project-content d-grid align-items-center">
                                            ...
                                            <ul>
                                                <li>
                                                    <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                                    <span><strong style="font-size: 15px !important;">৳{{ $advance_payment ?? '0.00'}}</strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap  ">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="font-weight-bolder">{{ Auth::user()->company_name ?? 'n/a'}}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        <p class="d-inline-block font-weight-semibold mb-0">Owner Name</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="font-weight-bolder">{{ Auth::user()->owner_name ?? 'n/a'}}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        <p class="d-inline-block font-weight-semibold mb-0">City Name</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="font-weight-bolder">{{ Auth::user()->city_name ?? 'n/a'}}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
