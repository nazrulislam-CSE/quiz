    ...
    <div class="container-fluid main-container ">
        <div class="main-header-left ">
            ...
            <div class="responsive-logo">
                <h5 class="text-uppercase font-weight-bolder text-light">Speak Up BD </h5>
            </div>
                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    <div class="main-img-user"><img alt="" src="{{ asset('dashboard/img/avatar5.png') }}"></div>
                                    <h6>{{ Auth::guard('admin')->user()->name }}</h6><span>{{ Auth::guard('admin')->user()->username }}</span>
                                </div>
