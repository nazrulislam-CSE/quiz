...
class TopicMcqController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
           return redirect()->route('admin.topic.mcq.index')->with('success', $import->getImportedCount() . ' MCQs imported successfully!');
    ...
    public function show($admission_id, $department_id, $subject_id, $topic_id)
    {
        ...
        return view('admin.topic.mcq.exam.show', compact('questions', 'pageTitle', 'topicInfo'));
    }
    ...
    {
        $pageTitle = 'Edit Topic MCQ Questions';
        ...
        return view('admin.topic.mcq.exam.edit', compact(
            'questions', 
            'topicInfo', 
            'pageTitle',
            'admissions',
