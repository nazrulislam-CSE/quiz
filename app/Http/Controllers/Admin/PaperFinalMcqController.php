...
class PaperFinalMcqController extends Controller
{
    ...
    public function index()
    {
        ...
        $mcqs = Mcq::where('mcq_type',3)->latest()->get();
    ...
    {
        $mcq = Mcq::with(['answers', 'admission', 'department','group', 'subject','paperFinal'])->findOrFail($id);
        $pageTitle = 'Paper Final MCQ Details';
        return view('admin.paper.mcq.show', compact('mcq', 'pageTitle'));
    }
    ...
    {
        $pageTitle = 'Edit Paper Final MCQ';
        ...
        $subjects = Subject::where('status', '1')->get();
        $papers = PaperFinal::where('status', '1')->get();
        return view('admin.paper.mcq.edit', compact('mcq', 'admissions', 'departments','groups','subjects','papers', 'pageTitle'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.paper.mcq.index')->with('success', 'MCQ updated successfully!');
    ...
    public function destroy(string $id)
    {
        ...
        $mcq->delete();
        return redirect()->route('admin.paper.mcq.index')->with('success', 'MCQ deleted successfully!');
    }
